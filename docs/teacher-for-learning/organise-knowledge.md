...
**Play this game that shows how organization matters**

(Modified from: [Fink, D. (2015) Creating Significant Learning Experiences. STLHE, Vancouver](https://waikato.primo.exlibrisgroup.com/permalink/64WAIKATO_INST/10hutka/alma9917198924503401).)
...
Did you notice the pattern of organization: that each word is associated with a number?
...
![UDL is intended to increase access to learning by reducing physical, cognitive, intellectual, and organizational barriers to learning, as well as other obstacles. UDL principles also lend themselves to implementing inclusionary practices in the classroom.Curriculum, as defined in the UDL literature, has four parts: instructional goals, methods, materials, and assessments.](https://elearn.waikato.ac.nz/draftfile.php/90614/user/draft/716891421/8527950743_1ee8212450_o.jpg) Learning should be designed to be accessible to everyone of all intersections of identity. Information should be conveyed in a variety of ways, known as “multiple means of representation.” For example, instead of using just a wall of text, consider adding some visual elements. If you do add an image you should explain it using the description tag available online. Sometimes a video is the best way to explain something, but if you use video, be sure to always include transcripts and captioning. (The information about [Universal Design for Learning](http://www.cast.org/impact/universal-design-for-learning-udl) goes into great depth about this.
...
![](https://elearn.waikato.ac.nz/draftfile.php/90614/user/draft/716891421/Extend%20Activity.png)
...
![Organized Notes](https://elearn.waikato.ac.nz/draftfile.php/90614/user/draft/716891421/organize_notes.jpg)
...
![Cornell notes with the page depicting the different sections of a template that could be used to take Cornell notes.](https://elearn.waikato.ac.nz/pluginfile.php/2873344/mod_book/chapter/14434/teacher-for-learning-organize-knowledge-note-taking.png)
...
![10 Minutes](https://elearn.waikato.ac.nz/pluginfile.php/2873344/mod_book/chapter/14434/extend-teacher.jpg)
...
**Select each item to learn more.** Open all panels
...
![logo](https://elearn.waikato.ac.nz/pluginfile.php/2856409/mod_book/chapter/14199/cc.svg)
